...
namespace Utils.HtmlHelpers
{
    public static class HtmlHelpers
    {
        public static IHtmlString CreateRemoveLink(this HtmlHelper htmlHelper, string linkText, string container, string deleteElement)
        {
